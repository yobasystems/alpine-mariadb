...
[![MariaDB Version](https://img.shields.io/badge/Mariadb%20version-v10.6.7-green.svg?style=for-the-badge&logo=mariadb)](https://mariadb.org/)


This Docker image [(yobasystems/alpine-mariadb)](https://hub.docker.com/r/yobasystems/alpine-mariadb/) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with [MariaDB v10.6.7](https://mariadb.org/) (MySQL Compatible) database server.
...
* ```:version``` Version tags e.g ```:10```, ```:10.6```, ```10.6.7```
