...
This Docker image [(yobasystems/alpine-mariadb)](https://hub.docker.com/r/yobasystems/alpine-mariadb/) is based on the minimal [Alpine Linux](http://alpinelinux.org/) with [Mariadb v10.1.22-r1](https://mariadb.org/) (MySQL Compatible) database server.
